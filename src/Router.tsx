...
import TransactionOrder from "@pages/layout/transactions/transaction-order/TransactionOrder";
        ...
        <Routes>
          ...
          >
            <Route>
              ...
              <Route path="/transaction/transaction-order" element={<TransactionOrder />} />
